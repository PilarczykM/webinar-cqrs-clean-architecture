            ...
            modelBuilder.Entity("Domain.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Author = "Damian",
                            CategoryId = 2,
                            Date = new DateTime(2022, 2, 22, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7378),
                        ...
                        new
                        {
                            ...
                            Author = "Stefan",
                            CategoryId = 5,
                            Date = new DateTime(2021, 8, 22, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7422),
                        ...
                        new
                        {
                            ...
                            Author = "Damian",
                            CategoryId = 2,
                            Date = new DateTime(2022, 2, 22, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7420),
                        ...
                        new
                        {
                            ...
                            Author = "Damian",
                            CategoryId = 2,
                            Date = new DateTime(2021, 8, 22, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7425),
                        ...
                        new
                        {
                            ...
                            Author = "Damian",
                            CategoryId = 2,
                            Date = new DateTime(2021, 8, 22, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7428),
                            Description = "Logowanie działania aplikacji. Jak wiedzieć w końcu, gdy coś nie działa. Mój blog jest napisany w C# i działa po ASP.NET CORE. Jak to jednak bywa z napisaną przez siebie aplikacją pojawiają się błędy więc do bloga dodałem mechanizm logowania błędów. W taki sposób znalazłem wiele dziwnych przypadków uszkodzonych wpisów w formacie XML, które rozwalały Parser. Znalazłem też złe zbudowane przez ze mnie lista kursów. ",
                            ImageUrl = "https://cezarywalenciuk.pl/Posts/programing/icons/_withbackground/R2/656_walidacja-z-fluentvalidation-waspnet-core--swagger.png",
                            Rate = 5,
                            Title = "NLog z ASP.NET Core : Logowanie błędów w aplikacji",
                        ...
                        new
                        {
                            ...
                            Author = "Damian",
                            CategoryId = 2,
                            Date = new DateTime(2021, 12, 22, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7431),
                        ...
                        new
                        {
                            ...
                            Author = "Adrian",
                            CategoryId = 3,
                            Date = new DateTime(2021, 5, 22, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7436),
                        ...
                        new
                        {
                            ...
                            Author = "Adrian",
                            CategoryId = 3,
                            Date = new DateTime(2021, 6, 22, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7434),
                        ...
                        new
                        {
                            ...
                            Author = "Adrian",
                            CategoryId = 4,
                            Date = new DateTime(2021, 5, 22, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7439),
                            Description = "Jak jeszcze lepiej ulepszyć system operacyjny Windows.\r\nCzy być może programy tobie, które za chwilę to śmieci, które nie będą ci potrzebne?\r\nZazwyczaj w tym cyklu pokazuje programy, z które moim bardzo zmieniają przepływ mojej pracy.",
                            ImageUrl = "https://cezarywalenciuk.pl/Posts/programing/icons/_withbackground/R2/656_walidacja-z-fluentvalidation-waspnet-core--swagger.png",
                            Rate = 9,
            ...
            modelBuilder.Entity("Domain.Entities.Webinar", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2022, 9, 1, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7520),
                        ...
                        new
                        {
                            Id = 2,
                            AlreadyHappend = false,
                            Date = new DateTime(2022, 7, 13, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7527),
                        ...
                        new
                        {
                            Id = 3,
                            AlreadyHappend = false,
                            Date = new DateTime(2022, 6, 23, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7530),
                        ...
                        new
                        {
                            Id = 4,
                            AlreadyHappend = false,
                            Date = new DateTime(2022, 6, 13, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7533),
                        ...
                        new
                        {
                            Id = 5,
                            AlreadyHappend = false,
                            Date = new DateTime(2022, 5, 24, 19, 17, 21, 501, DateTimeKind.Local).AddTicks(7537),
